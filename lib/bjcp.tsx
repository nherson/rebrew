...
// From https://raw.githubusercontent.com/ratherironic/2015-BJCP-Beer-Style-Guide-JSON/master/2015_Guidelines_Beer.json
const beers = {
  beers: [
    {
      ...
      subcategories: [
        {
          ...
          guidelines: {
            ...
            vitalStatistics: {
              og: "Variable by base style.",
              fg: "Variable by base style.",
              abv: "Variable by base style.",
          ...
          commercialExamples: [
            {
              name: "Boulevard Saison Brett",
            },
            {
              name: "Hill Farmstead Arthur",
            },
            {
              name: "Logsdon Seizoen Bretta",
            },
            {
              name: "Russian River Sanctification",
            },
            {
              name: "The Bruery Saison Rue",
            },
            {
              name: "Victory Helios",
            },
        ...
        },
        {
          ...
          guidelines: {
            ...
            vitalStatistics: {
              og: "Variable by style",
              fg: "Variable by style",
              abv: "Variable by style",
              ibu: "Variable by style",
              srm: "Variable by style",
            },
          },
          commercialExamples: [
            {
              name: "Boulevard Love Child",
            },
            {
              name: "Cascade Vlad the Imp Aler",
            },
            {
              name: "Jester King Le Petit Prince",
            },
            {
              name: "Jolly Pumpkin Calabaza Blanca",
            },
            {
              name: "Russian River Temptation",
            },
            {
              name: "The Bruery Rueuze",
            },
            {
        ...
        },
        {
          ...
          commercialExamples: [
            {
              name: "Cascade Bourbonic Plague",
            },
            {
              name: "Jester King Atrial Rubicite",
            },
            {
              name: "New Belgium Eric’s Ale",
            },
            {
              name: "New Glarus Belgian Red",
            },
            {
              name: "Russian River Supplication",
            },
            {
              name: "The Lost Abbey Cuvee de Tomme",
            },
          ],
          tags: [
            {
      ...
      subcategories: [
        {
          ...
          guidelines: {
            ...
            vitalStatistics: {
              og: "Vary depending on the underlying base beer",
              fg: "Vary depending on the underlying base beer",
              abv: "Vary depending on the underlying base beer",
              ibu: "Vary depending on the underlying base beer",
              srm:
                "Vary depending on the underlying base beer, but the fruit will often be reflected in the color.",
            },
          },
          commercialExamples: [
            {
      ...
      subcategories: [
        {
          ...
          guidelines: {
            ...
            vitalStatistics: {
              ...
              abv: "Vary depending on the underlying base beer.",
              ibu: "Vary depending on the underlying base beer.",
              srm: "Vary depending on the underlying base beer.",
            },
          },
          commercialExamples: [
            {
            ...
            {
              name: "Bell’s Java Stout",
            },
            {
              name: "Elysian Avatar Jasmine IPA",
            },
            {
        ...
        },
        {
          ...
          commercialExamples: [
            ...
            {
              name: "Lakefront Holiday Spice Lager Beer",
            },
            {
              name: "Weyerbacher Winter Ale",
            },
          ],
          tags: [
            {
      ...
      subcategories: [
        {
          ...
          commercialExamples: [
            {
              name: "Green’s Indian Pale Ale",
            },
            {
              name: "Lakefront New Grist",
            },
            {
              name: "New Planet Pale Ale",
            },
          ],
          tags: [
            {
      ...
      subcategories: [
        {
          ...
          guidelines: {
            ...
            vitalStatistics: {
              og: "Varies with the base beer style.",
              fg: "Varies with the base beer style.",
              abv: "Varies with the base beer style.",
              ibu: "Varies with the base beer style.",
              srm: "Varies with the base beer style.",
            },
          },
          commercialExamples: [
            {
            ...
            {
              name: "Schlenkerla Weizen Rauchbier and Ur-Bock Rauchbier",
            },
            {
              name: "Spezial Lagerbier",
            },
            {
              name: "Weissbier and Bockbier",
            },
            {
        ...
        },
        {
          ...
          guidelines: {
            ...
            vitalStatistics: {
              og: "Varies with the base beer style.",
              fg: "Varies with the base beer style.8",
              abv: "Varies with the base beer style.%",
              ibu: "Varies with the base beer style.",
              srm: "Varies with the base beer style.",
            },
      ...
      subcategories: [
        {
          ...
          commercialExamples: [
            ...
            {
              name: "Cigar City Humidor India Pale Ale",
            },
            {
              name: "Faust Holzfassgereifter Eisbock",
            },
            {
              name: "Firestone Walker Double Barrel Ale",
            },
            {
              name: "Great Divide Oak Aged Yeti Imperial Stout",
            },
            {
              name: "Petrus Aged Pale",
            },
            {
              name: "Samuel Smith Yorkshire Stingo",
            },
          ],
          tags: [
            {
        ...
        },
        {
          ...
          commercialExamples: [
            {
              name: "Founders Kentucky Breakfast Stout",
            },
            {
            ...
            {
              name:
                "The Lost Abbey Angel’s Share Ale; many microbreweries have specialty beers served only on premises often directly from the cask.",
            },
          ],
          tags: [
            {
      ...
      subcategories: [
        {
          ...
          guidelines: {
            ...
            overallImpression: "Based on declared clone beer.",
      ...
      subcategories: [
        {
          ...
          commercialExamples: [
            "[US] Uncle John’s Fruit House Winery Apple Hard Cider",
            "Tandem Ciders Pretty Penny (MI)",
            "Bellwether Spyglass (NY)",
            "West County Pippin (MA)",
            "White Winter Hard Apple Cider (WI)",
            "Wandering Aengus Ciderworks Bloom (OR)",
            "Æppeltreow Appely Brut and Doux (WI)",
          ],
        },

        {
          ...
          commercialExamples: [
            "[US] Westcott Bay Traditional Very Dry, Dry and Medium Sweet (WA)",
            "Farnum Hill Extra-Dry, Dry, and Farmhouse (NH)",
            "Wandering Aengus Oaked Dry (OR)",
            "Montana CiderWorks North Fork (MT), Bellwether Heritage (NY)",
            "[UK] Oliver’s Traditional Dry, Hogan’s Dry and Medium Dry",
            "Henney’s Dry and Vintage Still",
            "Burrow Hill Medium",
...

        {
          ...
          letter: "C",
          guidelines: {
            overallImpression: "Medium to sweet, full-bodied, rich.",
            aromaFlavor:
          ...
          commercialExamples: [
            "[US] West County Reine de Pomme (MA)",
            " [France] Eric Bordelet (various)",
            "Etienne Dupont",
...

        {
          ...
          guidelines: {
            ...
            entryInstructions:
              "Entrants MUST specify carbonation level (3 levels). Entrants MUST specify sweetness (5 categories). Entrants MUSTstate variety of pear(s) used.",
            varieties:
          ...
          commercialExamples: [
            "[US] Æppeltreow Orchard Oriole Perry (WI)",
            "[France] Bordelet Poire Authentique and Poire Granit, Christian Drouin Poire",
            "[UK] Oliver’s Classic, Blakeney Red, and Herefordshire Dry; Hogan’s Vintage Perry",
          ],
        },
      ],
    },

    {
      ...
      subcategories: [
...

        {
          ...
          commercialExamples: [
            "[US] West County Blueberry-Apple Wine (MA)",
            "Bellwether Cherry Street (NY)",
            "Uncle John’s Fruit Farm Winery Apple Cherry, Apple Blueberry, and Apricot Apple Hard Cider (MI)",
          ],
        },

        {
          ...
          commercialExamples: [
            "[US] Uncle John’s Fruit House Winery Fruit House Apple (MI),",
            "McClure’s Sweet Apple Wine (IN)",
          ],
        },

        {
          ...
          guidelines: {
            ...
            entryInstructions:
              "Entrants MUST specify starting gravity, final gravity or residual sugar, and alcohol level. Entrants MUSTspecify carbonation level (3 levels).",
            varieties:
          ...
          commercialExamples: [
            "[US] various from Eden Ice Cider Company and Champlain Orchards",
            "[Canada] Domaine Pinnacle, Les Vergers de la Colline, and Cidrerie St-Nicolas (Quebec)",
          ],
        },

        {
          ...
          commercialExamples: [
            "[US] Colorado Cider Grasshop-ah (CO)",
            "Wandering Aengus Anthem Hops (OR)",
          ],
        },

        {
          ...
          commercialExamples: ["[US] Finn River Fire Barrel (WA)"],
        },
      ],
    },
  ],
      ...
      subcategories: [
        {
          ...
          guidelines: {
            ...
            ingredients:
              "Standard description applies. Traditional Meads feature the character of a blended honey or a blend of honeys. Varietal meads feature the distinctive character of certain honeys. Show meadsfeature no additives, but this distinction is usually not obvious to judges.",
            entryInstructions:
...

        {
          ...
          commercialExamples: [
            ...
            "Intermiel Verge d’Or and Mélilot",
          ],
        },

        {
          ...
          commercialExamples: [
            ...
            "Chaucer’s Mead",
            "Rabbit’s Foot Sweet Wildflower Honey Mead",
            "Intermiel Benoîte",
          ],
        },
      ],
...

    {
      ...
      subcategories: [
...

        {
          ...
          commercialExamples: [
            "Moonlight Blissful, Wild, Caress, and Mischief",
            "White Winter Blueberry, Raspberry and Strawberry Melomels",
            "Celestial Meads Miel Noir",
            "Redstone Black Raspberry Nectar",
            "Bees Brothers Raspberry Mead",
            "Intermiel Honey Wine and Raspberries, Honey Wine and Blueberries, and Honey Wine and Blackcurrants",
...

        {
          ...
          commercialExamples: [
            "Mountain Meadows Cherry Mead",
            "Moonlight Entice, Sumptuous, Flirt, and Smitten",
...

        {
          ...
          commercialExamples: ["Moonlight Desire, Paramour, and Iniquity"],
        },
      ],
    },
      ...
      subcategories: [
        {
          ...
          commercialExamples: [
            "Moonlight Kurt’s Apple Pie, Mojo, Flame, Fling, and Deviant",
            "Celestial Meads Scheherazade",
            "Rabbit’s Foot Private Reserve Pear Mead",
            "Intermiel Rosée",
          ],
        },

        {
          ...
          commercialExamples: [
            "Moonlight Wicked, Breathless, Madagascar, and Seduction",
            "Redstone Vanilla Beans and Cinnamon Sticks Mountain Honey Wine",
            "Bonair Chili Mead",
            "Redstone Juniper Mountain Honey Wine",
            "Qhilika Africa Birds Eye Chili Mead",
            "Mountain Meadows Spice Nectar",
          ],
        },
      ],
    },
      ...
      subcategories: [
        {
          ...
          commercialExamples: [
            "Rabbit’s Foot Diabhal and Bière de Miele",
            "Magic Hat Braggot",
...

        {
          ...
          commercialExamples: ["Jadwiga", "Saba Tej"],
        },
